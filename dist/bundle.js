...
/***/ function(module, exports, __webpack_require__) {
	...
	var _expect = __webpack_require__(181);
	...
	var initialState = {
	    ...
	    filters: ['SHOW_ALL', 'SHOW_ACTIVE', 'SHOW_INACTIVE'],
	    tabs: [{
	        id: 1,
	        title: "First Tab",
	...
	var TabHeading = function TabHeading(_ref) {
	...
	var RemTabBtn = function RemTabBtn(_ref2) {
	...
	var Tab = function Tab(_ref3) {
	    ...
	    var handleTabOpen = _ref3.handleTabOpen;
	    var handleRemoveTab = _ref3.handleRemoveTab;
	
	    var tabContent = active ? _react2.default.createElement(
	        'div',
	    ...
	    return _react2.default.createElement(
	        'div',
	        { className: 'tab' },
	        _react2.default.createElement(TabHeading, { title: title, onClick: function onClick() {
	                return handleTabOpen(id);
	            } }),
	        _react2.default.createElement(RemTabBtn, { onClick: function onClick() {
	                return handleRemoveTab(id);
	            } }),
	        tabContent
	    );
	};
	...
	var mapTabStateToProps = function mapTabStateToProps(state) {
	    return {
	        tabs: state.tabs
	    };
	};
	
	var mapTabDispatchToProps = function mapTabDispatchToProps(dispatch) {
	
	    return {
	        handleTabOpen: function handleTabOpen(id) {
	            return dispatch((0, _actions.toggleTabAction)(id));
	        },
	        handleRemoveTab: function handleRemoveTab(id) {
	            return dispatch((0, _actions.removeTabAction)(id));
	        }
	    };
	};
	
	var InteractiveTab = (0, _reactRedux.connect)(mapTabStateToProps, mapTabDispatchToProps)(Tab);
	
	var AddTab = function AddTab(_ref4) {
	    var dispatch = _ref4.dispatch;
	
	    var inputTitle = undefined,
	        ...
	        _react2.default.createElement(
	            'button',
	            {
	                ...
	                onClick: function onClick() {
	                    dispatch((0, _actions.addTabAction)(inputTitle.value, inputContent.value));
	                    inputTitle.value = '';
	                    inputContent.value = '';
	                } },
	            'Add Tab'
	...
	AddTab = (0, _reactRedux.connect)()(AddTab);
	
	var TabFilter = function TabFilter(_ref5) {
	...
	var mapTabFilterStateToProps = function mapTabFilterStateToProps(state) {
	    return {
	        filters: state.filters
	    };
	};
	
	var mapTabFilterDispatchToProps = function mapTabFilterDispatchToProps(dispatch) {
	    return {
	        onChange: function onChange(val) {
	            return dispatch((0, _actions.changeFilterAction)(val));
	        }
	    };
	};
	
	var TabFilterContainer = (0, _reactRedux.connect)(mapTabFilterStateToProps, mapTabFilterDispatchToProps)(TabFilter);
	
	var TabList = function TabList(_ref6) {
	    var tabs = _ref6.tabs;
	    ...
	    return _react2.default.createElement(
	        ...
	        tabs.map(function (tab, index) {
	            return _react2.default.createElement(InteractiveTab, _extends({ key: index }, tab));
	        })
	    );
	};
	...
	var store = (0, _redux.createStore)(_reducers.tabs, initialState);
	
	var mapStateToProps = function mapStateToProps(state) {
	
	    return {
	        tabs: (0, _reducers.getTabs)(state.tabs, state.visibilityFilter)
	    };
	};
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        onTabClick: function onTabClick(id) {
	            dispatch((0, _actions.toggleTabAction)(id));
	        }
	    };
	};
	
	var InteractiveTabList = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(TabList);
	    ...
	    _createClass(Accordion, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(AddTab, null),
	                _react2.default.createElement(TabFilterContainer, null),
	                _react2.default.createElement(InteractiveTabList, null)
	            );
	        }
	    }]);
	...
	_reactDom2.default.render(_react2.default.createElement(
	    ...
	    { store: store },
	    _react2.default.createElement(Accordion, null)
...
/***/ function(module, exports) {
	...
	var toggleTab = exports.toggleTab = function toggleTab() {
	...
	var addTab = exports.addTab = function addTab() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
	    var action = arguments[1];
	...
	var removeTab = exports.removeTab = function removeTab() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
	    var action = arguments[1];
	...
	var getTabs = exports.getTabs = function getTabs() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
	    var visibilityFilter = arguments.length <= 1 || arguments[1] === undefined ? 'DEFAULT_FILTER' : arguments[1];
	...
	var tabs = exports.tabs = function tabs() {
	    ...
	    switch (action.type) {
	        ...
	        case 'TOGGLE_TAB':
	            return _extends({}, state, { tabs: toggleTab(state.tabs, action) });
	
	        case 'ADD_TAB':
	            return _extends({}, state, { tabs: addTab(state.tabs, action) });
	
	        case 'REMOVE_TAB':
	            return _extends({}, state, { tabs: removeTab(state.tabs, action) });
	
	        case 'SET_VISIBILITY_FILTER':
	            return _extends({}, state, {
	                visibilityFilter: action.filter,
	                tabs: getTabs(state.tabs, action.visibilityFilter)
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.changeFilterAction = exports.toggleTabAction = exports.removeTabAction = exports.addTabAction = undefined;
	...
	function setVisibilityFilter(filter) {
	    return {
	        type: _constants.SET_VISIBILITY_FILTER,
	        filter: filter
	    };
	}
	...
	var addTabAction = exports.addTabAction = function addTabAction(title, content) {
	...
	var removeTabAction = exports.removeTabAction = function removeTabAction(id) {
	    return {
	        type: 'REMOVE_TAB',
	        payload: { id: id }
	    };
	...
	var toggleTabAction = exports.toggleTabAction = function toggleTabAction(id) {
	    return {
	        type: 'TOGGLE_TAB',
	        id: id
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Expectation = __webpack_require__(182);
	
	var _Expectation2 = _interopRequireDefault(_Expectation);
	
	var _SpyUtils = __webpack_require__(200);
	
	var _assert = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TestUtils = __webpack_require__(201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectInspect = __webpack_require__(199);
